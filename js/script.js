...
for (const song of songs) {
   ...
   ` <li>
                ...
                <div class="playnow">
                  <span> Play Now</span>
                  <img src="images/playnow.svg" alt="PLAY">
                </div>
...
async function displayAlbums(){
    ...
    for(let index=0; index < array.length; index++){
        ...
        if(e.href.includes("/songs") && !e.href.includes(".htaccess")){
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
              <div class="play">
                <svg
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50" height="50" color="#000000" fill="#1ed760">
              ...
              <img src="/songs/${folder}/cover.jpg" alt="Qatal" />
    ...
    //load the playlist as the card is clicked
...
//adding an eventlistener to seekbar
